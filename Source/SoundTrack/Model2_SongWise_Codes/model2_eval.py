...
tf.app.flags.DEFINE_integer('eval_interval_secs', 0.75 * 60,
                            """How often to run the eval.""")
tf.app.flags.DEFINE_integer('num_examples', 1968,
...
def eval_once(saver, logits, labels, top_k_op, conf_mat, loss):
...
def evaluate():
	with tf.device('/cpu:0'):
	  with tf.Graph().as_default() as g:
	    ...
	    while True:
	      eval_once(saver,logits, labels, top_k_op, conf_mat, loss)
	      if FLAGS.run_once:
		break

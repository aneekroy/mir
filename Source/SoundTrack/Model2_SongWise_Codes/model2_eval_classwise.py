...
tf.app.flags.DEFINE_string('eval_dir', '/home/satyaki/Emotion/Soundtrack/Model2_SongWise/Evaluation_Logs',
                           """Directory where to write event logs.""")
tf.app.flags.DEFINE_string('eval_data', 'test',
                           """Either 'test' or 'train_eval'.""")
tf.app.flags.DEFINE_string('checkpoint_dir', '/home/satyaki/Emotion/Soundtrack/Model2_SongWise/Training_Logs',
...
def evaluate(ind = None):
  ...
  while True:
    with tf.Graph().as_default() as g:
      predictionfile = open("/home/satyaki/Emotion/Soundtrack/Model2_SongWise/Outputs/output_" + str(index) + ".txt", "w")
      sequencefile = open("/home/satyaki/Emotion/Soundtrack/Model2_SongWise/Outputs/output_sequence_" + str(index) + ".txt", "w")

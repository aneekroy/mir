...
tf.app.flags.DEFINE_string('eval_dir', '/home/soms/EmotionMusic/Model3/Evaluation_Logs',
                           """Directory where to write event logs.""")
tf.app.flags.DEFINE_string('eval_data', 'test',
                           """Either 'test' or 'train_eval'.""")
tf.app.flags.DEFINE_string('checkpoint_dir', '/home/soms/EmotionMusic/Model3/Training_Logs',
...
def evaluate(ind = None):
  ...
  testdir = "/home/soms/EmotionMusic/Model3/Data/Test"
  index = ind if ind is not None else 0
  while True:
    with tf.Graph().as_default() as g:
      predictionfile = open("/home/soms/EmotionMusic/Model3/Outputs/output_" + str(index) + ".txt", "w")
      sequencefile = open("/home/soms/EmotionMusic/Model3/Outputs/output_sequence_" + str(index) + ".txt", "w")
...
if __name__ == '__main__':
  try:
    ...
    print("Usage: python model3_eval_classwise.py index")
    sys.exit(0)
  evaluate(ind)
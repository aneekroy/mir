...
tf.app.flags.DEFINE_string('train_dir', '/home/soms/EmotionMusic/Model3/Training_Logs',
                           """Directory where to write event logs """
                           """and checkpoint.""")
tf.app.flags.DEFINE_integer('max_steps', 1000000,
                            """Number of batches to run.""")
tf.app.flags.DEFINE_integer('num_examples_per_step', 64,
                            """Number of batches to run.""")
...
def train():
  with tf.Graph().as_default():
    ...
    loss_summary = tf.scalar_summary("Training_Loss", loss)
    ...
    stepfile = "/home/soms/EmotionMusic/Model3/stepfile.txt" 

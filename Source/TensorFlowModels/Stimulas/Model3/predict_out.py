...
if __name__ == "__main__":
	get_accuracy("/home/soms/EmotionMusic/Saved_Logs/Model3/Outputs/output_sequence_" + str(sys.argv[1]) + ".txt", run_length_enable = False, run_length_tolerance = None, tot_clips_tolerance = None)

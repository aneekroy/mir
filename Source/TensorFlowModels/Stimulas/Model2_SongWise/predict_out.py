...
if __name__ == "__main__":
	get_accuracy("/home/soms/EmotionMusic/Model2_SongWise/Outputs/output_sequence_1.txt", run_length_tolerance = 0.2, tot_clips_tolerance = 0.25)
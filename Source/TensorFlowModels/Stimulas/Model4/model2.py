...
# ConvPool3
model.add(Convolution2D(256, 3, 3, border_mode = 'same', activation = 'relu', W_constraint = maxnorm(3), W_regularizer = l2(0.01)))
model.add(MaxPooling2D(pool_size = (2, 2), strides = (2, 2)))
...
# Checkpointing
filepath = "/home/soms/EmotionMusic/Model4/Saved_Weights_2/weights_best.hdf5"

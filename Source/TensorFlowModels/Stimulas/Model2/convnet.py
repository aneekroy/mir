...
tf.app.flags.DEFINE_integer('batch_size', 2126,
                            """Number of images to process in a batch.""")
tf.app.flags.DEFINE_string('data_dir', '/home/soms/EmotionMusic/Model2',
...
#IMAGE_SIZE = 32
NUM_CLASSES = 12
NUM_EXAMPLES_PER_EPOCH_FOR_TRAIN = 8480
NUM_EXAMPLES_PER_EPOCH_FOR_EVAL = 2126
...
def inference(images, eval = False):
  ...
  with tf.variable_scope('conv1') as scope:
    kernel = _variable_with_weight_decay('weights', shape=[7, 12, 1, 64], stddev=5e-2, wd=0.0)
  ...
  with tf.variable_scope('local3') as scope:
    ...
    batch_size = FLAGS.batch_size if eval else 8

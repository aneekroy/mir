...
def inference(images, eval = False):
  ...
  with tf.variable_scope('conv1') as scope:
    kernel = _variable_with_weight_decay('weights', shape=[10, 32, 1, 64], stddev=5e-2, wd=0.0)
  ...
  # pool1
  pool1 = tf.nn.max_pool(drop1, ksize=[1, 4, 4, 1], strides=[1, 2, 2, 1], padding='SAME', name='pool1')
  ...
  with tf.variable_scope('conv2') as scope:
    kernel = _variable_with_weight_decay('weights', shape=[5, 10, 64, 128], stddev=5e-2, wd=0.0)

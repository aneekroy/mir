...
tf.app.flags.DEFINE_string('train_dir', '/home/soms/EmotionMusic/ModelRaga/Training_Logs',
...
def train():
  with tf.Graph().as_default():
    ...
    images, labels = convlstm.inputs(eval_data = False)

    # Build a Graph that computes the logits predictions from the
    # inference model.
    logits = convlstm.inference(images)
    ...
    train_op = convlstm.train(loss, global_step)
    ...
    stepfile = "/home/soms/EmotionMusic/ModelRaga/stepfile.txt" 
